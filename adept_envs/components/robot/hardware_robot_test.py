...
from adept_envs.components.robot.hardware_robot import (HardwareRobotComponent,
                                                        RobotState)
from adept_envs.utils.testing.mock_sim_scene import MockSimScene
from adept_envs.utils.testing.mock_time import patch_time
...
class HardwareRobotComponentTest(absltest.TestCase):
    ...
    def test_timestep(self):
        ...
        with patch_time(
                'adept_envs.components.robot.hardware_robot.time',
