...
from adept_envs.robot_env import RobotEnv
from adept_envs.utils.testing.mock_sim_scene import patch_sim_scene
...
class TestEnv(RobotEnv):
    ...
    def __init__(self, nq=1, **kwargs):
        ...
        with patch_sim_scene('adept_envs.robot_env.SimScene', nq=nq):
