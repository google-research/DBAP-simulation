...
import time
ASSET_PATH = 'adept_envs/franka/assets/franka_microwave.xml'
...
class FrankaMicrowave(BaseFrankaEnv):
    ...
    def get_reward_dict(self,
        ...
        microwave_error = obs_dict['obj_qp'] - (-1.0)
        reward_dict = collections.OrderedDict((
            ('ee_microwave', -1 * np.linalg.norm(ee_error)),
            ('microwave_door', -10 * np.linalg.norm(microwave_error)),
        ))
        return reward_dict
